...
VALUES
  ...
  (
    ...
    20,
    55000.00,
    'Làm thơm phòng, thư giãn tinh thần',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    4,
    'Tinh dầu Hoa Hồi 15ml',
    18,
    65000.00,
    'Dung tích vừa, tiện dụng',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    5,
    'Tinh dầu Hoa Hồi 20ml',
    15,
    70000.00,
    'Phù hợp dùng gia đình',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    6,
    'Tinh dầu Hoa Hồi 25ml',
    12,
    75000.00,
    'Hương thơm nhẹ, bền lâu',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    7,
    'Tinh dầu Hoa Hồi nguyên chất',
    25,
    80000.00,
  ...
  (
    8,
    'Tinh dầu Hoa Hồi mix cam',
    22,
    60000.00,
    'Hương thơm tươi mát, dễ chịu',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    9,
    'Tinh dầu Hoa Hồi mix quế',
    16,
    72000.00,
    'Kết hợp ấm áp, thư giãn',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    10,
    'Tinh dầu Hoa Hồi mix sả',
    14,
    68000.00,
    'Khử mùi, đuổi muỗi hiệu quả',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    11,
    'Tinh dầu Hoa Hồi mix oải hương',
    10,
    90000.00,
    'Tạo giấc ngủ ngon, thư thái',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  ),
  (
    12,
    'Tinh dầu Hoa Hồi cao cấp',
    8,
    95000.00,
    'Chất lượng cao, hương thơm sang trọng',
    '2025-09-26 07:53:15',
    '2025-09-26 07:53:15'
  );
...
VALUES
  (
    1,
    1,
    'uploads/tinh_dau_hoi_la_gi_cong_dung_cua.png'
  ),
  (2, 1, 'uploads/images.png');
...
CREATE TABLE
  `provinces` (
    ...
    CONSTRAINT `provinces_ibfk_1` FOREIGN KEY (`administrative_unit_id`) REFERENCES `administrative_units` (`id`)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
VALUES
  (
    ...
    'Trị',
    'Viên',
    'vanctquantrivien@gmail.com',
    '0976812898',
    'admin',
    'https://lh3.googleusercontent.com/a/ACg8ocIeLA2HATdB14fGGlGX-HmMn5YRfdZAw8I3tSGU_uy7dUIZazo=s96-c',
    '2025-08-07 09:01:59',
    '2025-08-14 15:13:13'
  ),
  (
  ...
  (
    ...
    'Thế',
    'Văn',
    'chuthevan450@gmail.com',
    '0385913898',
    'customer',
    'https://lh3.googleusercontent.com/a/ACg8ocK4e9d6NuZ6LjbW67ORCCOADLoTH280IR8UgS7Me5q9woM0ER3iMg=s96-c',
    '2025-08-07 09:04:39',
    '2025-09-26 00:56:56'
  ),
  (
    ...
    '',
    'Văn (K17HL)',
    'vancthe170807@fpt.edu.vn',
    '0976812898',
    'customer',
    'https://lh3.googleusercontent.com/a/ACg8ocLENaM4AeJabJz8q_t59dTumSo1a4RBXxydJIxqg6JUbwVJrkRK=s96-c',
    '2025-08-14 15:09:44',
    '2025-09-20 15:19:06'
  ),
  (
    ...
    '',
    'Thế Văn (Văn CT)',
    'chuthevan1281@gmail.com',
    NULL,
    'customer',
    'https://lh3.googleusercontent.com/a/ACg8ocLpkeh6Neq6PPcqCbI4YZ_3QVEHyZakxRvSw256YqXV5xIxAcM=s96-c',
    '2025-08-14 15:12:13',
    '2025-08-14 15:12:13'
  ),
  (
    ...
    'Thế',
    'Văn (Văn CT)',
    'vanct20030625@gmail.com',
    NULL,
    'customer',
    'https://lh3.googleusercontent.com/a/ACg8ocJAih8WJ4CfaPl_x6nsIcsnvT0JC9MH0VqvZjTyJWCKXApBCgo=s96-c',
    '2025-09-18 10:21:42',
    '2025-09-18 10:22:13'
  );
...
CREATE TABLE
  `wards` (
    ...
    CONSTRAINT `wards_ibfk_1` FOREIGN KEY (`administrative_unit_id`) REFERENCES `administrative_units` (`id`),
    CONSTRAINT `wards_ibfk_2` FOREIGN KEY (`province_code`) REFERENCES `provinces` (`code`)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
VALUES
  ...
  (
    ...
    'Co To',
    'Đặc khu Cô Tô',
    'Co To Special administrative region',
    'co_to',
    '22',
    5
  ),
  ...
  (
    ...
    'Cat Hai',
    'Đặc khu Cát Hải',
    'Cat Hai Special administrative region',
    'cat_hai',
    '31',
    5
  ),
  (
    ...
    'Bach Long Vi Special administrative region',
    'bach_long_vi',
    '31',
    5
  ),
  ...
  (
    ...
    'Con Co',
    'Đặc khu Cồn Cỏ',
    'Con Co Special administrative region',
    'con_co',
    '44',
    5
  ),
  ...
  (
    ...
    'Hoang Sa',
    'Đặc khu Hoàng Sa',
    'Hoang Sa Special administrative region',
    'hoang_sa',
    '48',
    5
  ),
  ...
  (
    ...
    'Ly Son',
    'Đặc khu Lý Sơn',
    'Ly Son Special administrative region',
    'ly_son',
    '51',
    5
  ),
  ...
  (
    ...
    'Truong Sa',
    'Đặc khu Trường Sa',
    'Truong Sa Special administrative region',
    'truong_sa',
    '56',
    5
  ),
  ...
  (
    ...
    'Phu Quy',
    'Đặc khu Phú Quý',
    'Phu Quy Special administrative region',
    'phu_quy',
    '68',
    5
  ),
  ...
  (
    ...
    'Con Dao',
    'Đặc khu Côn Đảo',
    'Con Dao Special administrative region',
    'con_dao',
    '79',
    5
  ),
  ...
  (
    ...
    'Phu Quoc',
    'Đặc khu Phú Quốc',
    'Phu Quoc Special administrative region',
    'phu_quoc',
    '91',
    5
  ),
  (
    ...
    'Tho Chau',
    'Đặc khu Thổ Châu',
    'Tho Chau Special administrative region',
    'tho_chau',
    '91',
    5
  ),
  (
    ...
    'Kien Hai',
    'Đặc khu Kiên Hải',
    'Kien Hai Special administrative region',
    'kien_hai',
    '91',
    5
  ),
...
-- Dump completed on 2025-09-27 14:19:45