...
LOCK
TABLES `administrative_units` WRITE;
...
VALUES (1, 'Thành phố trực thuộc trung ương', 'Municipality', 'Thành phố', 'City', 'thanh_pho_truc_thuoc_trung_uong',
       ...
       (5, 'Đặc khu tại hải đảo', 'Special administrative region', 'Đặc khu', 'Special administrative region',
...
(
    ...
    PRIMARY KEY (`id`),
    KEY           `userId` (`userId`),
    CONSTRAINT `auditlogs_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY          `orderId` (`orderId`),
    CONSTRAINT `shippinginfo_ibfk_1` FOREIGN KEY (`orderId`) REFERENCES `orders` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users`
VALUES (1, 'admin', 'Quản', 'Trị', 'Viên', 'vanctquantrivien@gmail.com', '0976812898', 'admin',
        'https://lh3.googleusercontent.com/a/ACg8ocIeLA2HATdB14fGGlGX-HmMn5YRfdZAw8I3tSGU_uy7dUIZazo=s96-c',
        '2025-08-07 09:01:59', '2025-08-14 15:13:13'),
       (2, 'admin2', 'Quản', 'Trị', 'Viên 2', 'banhuongadmin@gmail.com', '0399349064', 'admin', NULL,
        '2025-08-07 09:03:22', '2025-08-07 09:05:49'),
       (3, 'vanct', 'Chu', 'Thế', 'Văn', 'chuthevan450@gmail.com', '0385913898', 'customer',
        'https://lh3.googleusercontent.com/a/ACg8ocIgMDwweyO5mf8RpLLA5uHAdgy4MKA2UpPPgeriizqAbRPRaMZahQ=s96-c',
        '2025-08-07 09:04:39', '2025-08-14 15:05:02'),
       (4, 'vancthe170807', 'Chu', '', 'Thế Văn (K17HL)', 'vancthe170807@fpt.edu.vn', NULL, 'customer',
        'https://lh3.googleusercontent.com/a/ACg8ocLENaM4AeJabJz8q_t59dTumSo1a4RBXxydJIxqg6JUbwVJrkRK=s96-c',
        '2025-08-14 15:09:44', '2025-08-14 15:09:44'),
       (5, 'chuthevan1281', 'Chu', '', 'Thế Văn (Văn CT)', 'chuthevan1281@gmail.com', NULL, 'customer',
        'https://lh3.googleusercontent.com/a/ACg8ocLpkeh6Neq6PPcqCbI4YZ_3QVEHyZakxRvSw256YqXV5xIxAcM=s96-c',
        '2025-08-14 15:12:13', '2025-08-14 15:12:13'),
       (6, 'vanct20030625', 'Chu', '', 'Thế Văn (Văn CT)', 'vanct20030625@gmail.com', NULL, 'customer',
        'https://lh3.googleusercontent.com/a/ACg8ocJAih8WJ4CfaPl_x6nsIcsnvT0JC9MH0VqvZjTyJWCKXApBCgo=s96-c',
        '2025-08-15 01:37:35', '2025-08-15 01:37:35');
